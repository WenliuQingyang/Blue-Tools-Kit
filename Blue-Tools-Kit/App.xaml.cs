using Blue_Tools_Kit.Activation;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<Blue_TalkViewModel>();
            services.AddTransient<Blue_TalkPage>();
            services.AddTransient<pluginsDetailViewModel>();
            services.AddTransient<pluginsDetailPage>();
            services.AddTransient<pluginsViewModel>();
            services.AddTransient<pluginsPage>();
            services.AddTransient<Kivo_WikiViewModel>();
            services.AddTransient<Kivo_WikiPage>();
